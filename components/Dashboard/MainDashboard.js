...
const MainDashboard = () => {
  ...
  return (
    <section className={`bg-[#F3F4F6] h-full pl-[200px] pl-[45px]"`}>
      <div className="bg-[#00073d]  px-4">
        <div className="flex justify-between items-center">
          <div>
            <img
              className=""
              src="https://i.ibb.co/8Pvs63n/download-removebg-preview.png"
              alt=""
            />
          </div>
          <div className="flex items-center">
            <div className="mr-4">
              <span className="relative inline-block ml-8 mt-3 cursor-pointer">
                <svg
                  className="w-6 h-6 text-xl text-gray-50 fill-current"
                  viewBox="0 0 20 20"
                >
            ...
            <div>
              <img
                ...
                src="https://i.ibb.co/bzQpNYJ/user-1.png"
                alt=""
              />
            </div>
          </div>
      ...
      <div className="lg:mx-16 md:mx-12 sm:mx-10 py-24">
        <div className="grid gap-4 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1">
          <div className="bg-white p-8 rounded-md flex items-center justify-around">
            <div>
              <h2 className="text-2xl font-sans mb-4 font-semibold text-gray-600">
                Active Seller
              </h2>
            ...
            <div>
              <img
                className="w-full"
                src="https://i.ibb.co/80ftVNV/Screenshot-1.png"
                alt=""
              />
            </div>
          </div>
          <div className="bg-white p-8 rounded-md flex items-center justify-around">
            ...
            <div>
              <img
                className="w-full"
                src="https://i.ibb.co/8B0WjfH/Screenshot-2.png"
                alt=""
              />
            </div>
          </div>
          <div className="bg-white p-8 rounded-md flex items-center justify-around">
            ...
            <div>
              <img
                className="w-full"
                src="https://i.ibb.co/Zm4MDGL/Screenshot-3.png"
                alt=""
              />
            </div>
          </div>
          <div className="bg-white p-8 rounded-md flex items-center justify-around">
            ...
            <div>
              <img
                className="w-full"
                src="https://i.ibb.co/0VdCK0g/Screenshot-4.png"
                alt=""
              />
            </div>
          </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 mt-20">
          <div className="bg-white p-8">
            <h2 className="text-3xl mb-4 font-semibold text-center font-sans">
              Activity
            </h2>
