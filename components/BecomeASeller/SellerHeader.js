        ...
        <div className="container m-auto flex justify-between items-center text-gray-700">
          <div className="flex items-center ">
            ...
            >
              ...
              <button
                ...
                className="p-2 bg-[#19A463] text-white px-4 rounded-tr-md rounded-br-md"
              >
                Search
              </button>
            </form>
          ...
          <ul className="hidden md:flex items-center  text-base font-semibold text-white cursor-pointer">
            ...
            <Link href="/become&seller">
              <a className="hover:text-red-500 text-lg py-4 px-6">
                Become a Seller
              </a>
            </Link>

            <button className="bg-green-600 text-lg hover:bg-red-500 translate-all transition duration-300 rounded-md font-bold py-1 px-4 border-0 shadow ring-1 ring-red-300">
              Sign Out
            </button>
  ...
  group-focus:right-0 group-focus:opacity-100 transition-all duration-300"
            >
              <ul className="flex flex-col items-end w-full text-base cursor-pointer pt-10">
                <Link href="/">
                  <a className="hover:text-red-500 mr-10 text-lg pt-6 pb-2 px-6">
                    Home
                  </a>
                </Link>
                <Link href="/">
                  <a className="hover:text-red-500 mr-10 text-lg py-2  px-6">
                    Contact
                  </a>
                </Link>
                <Link href="/">
